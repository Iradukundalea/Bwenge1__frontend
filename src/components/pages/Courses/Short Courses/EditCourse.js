...
const EditCourse = () => {
    ...
    const submitPaperHandler = async (e) => {
        ...
        const config = {
            method: "patch",
            url: `http://localhost:5000/course/editcourse/${selectedCourse._id}`,
            headers: {
            ...
            <div className="center">
                ...
                <form onSubmit={submitPaperHandler} method="post" encType="multipart/formdata">
                    ...
                    <div className="inputbox">
                        ...
                        <select value={course.type} className="cal" onChange={(e) => setCourse({ ...course, type: e.target.value })}>
                    ...
                    {course.errors && <span className="error-message">{course.errors}</span>}
                </form>
