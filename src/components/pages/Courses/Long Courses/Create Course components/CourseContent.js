      ...
      <div>
        ...
        <div className="ui form">
          <div className="field">
            ...
            {
              <button class="ui right compact icon button my-3">
                <input
                  type="file"
                  id="qfile1"
                  onChange={(e) => {
  ...
  const renderLectureFiles = (chapter, lectur, files) => {
    return files.map((file) => {
      if (file.fileLocation.type) {
        ...
        console.log(file.fileLocation.substr(file.fileLocation.length - 4, 4));
        return (
          <div>
    ...
    return props.MoocCourse.chapters.map((chapter) => {
      ...
      return (
        <div class="ui raised segment chapterT item-container">
          <div className="chapterT">
            <p>
              <b> Chapter {count}:</b> <span>{chapter.title}</span>
              <img
                onClick={(e) => {
                  setAddChapModal({
                    onOpen: true,
                  ...
                  <div class="ui raised segment lectureT" style={{ backgroundColor: "lavender" }}>
                    ...
                    >
                      <div style={{ paddingTop: "5px" }}>
                        <p>
                          <b>Lecture {countLec}:</b> <span>{lectur.title}</span>
                          <img
                            onClick={(e) => {
                              setAddLectureModal({
                                onOpen: true,
