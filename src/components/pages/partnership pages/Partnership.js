...
const Partnership = () => {
  ...
  const onSubmitPartner = (e) => {
    ...
    const config = {
      method: "post",
      url: "http://13.59.38.98:5000/partnership/insertpartner",
      headers: {
      ...
      <div class="ui large form">
        ...
        <div className="two fields">
          ...
          <div class="field">
            ...
            <input
              ...
              type="text"
              value={indivPartner.companyName}
            />
          </div>
        </div>
        <div className="two fields">
          ...
          <div class="field">
            ...
            <input
              ...
              type="tel"
              value={indivPartner.phoneNumber}
            />
          </div>
        </div>
        ...
        <div className="field">
          ...
          <input
            ...
            type="text"
            value={indivPartner.partnerType}
          />
        </div>
        <div className="field">
          ...
          <input
            onChange={(e) => {
              setIndivPartner({
                ...indivPartner,
                marketOfInterest: e.target.value,
              });
            }}
            type="text"
            value={indivPartner.marketOfInterest}
          />
        </div>
        <div className="field">
          ...
          <input
            onChange={(e) => {
              setIndivPartner({
                ...indivPartner,
                fieldOfExpertise: e.target.value,
              });
            }}
            type="text"
            value={indivPartner.fieldOfExpertises}
          />
        </div>
        <div onClick={(e) => onSubmitPartner(e)} class="ui submit button">
          Submit
        </div>
      </div>
    </div>
