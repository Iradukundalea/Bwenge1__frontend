      ...
      <div class="ui large form">
        <div class="two fields">
          <div class="field">
            ...
            <input
              ...
              type="text"
              value={orgPartner.organizationName}
            />
          </div>
        </div>
        ...
        <div className="field">
          ...
          <input
            ...
            type="text"
            value={orgPartner.marketOfInterest}
          />
        </div>
