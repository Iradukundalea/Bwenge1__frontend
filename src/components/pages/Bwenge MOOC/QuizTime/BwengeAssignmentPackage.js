...
const BwengeAssignmentPackage = () => {
  ...
  const { data, loading, error } = useBwengeCourseAssignment(courseId, assignmentId);
...
export default BwengeAssignmentPackage;
